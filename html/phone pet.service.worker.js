...
/** @type {string} */
const CACHE_VERSION = '1757155702|1778616900';
/** @type {string} */
const CACHE_PREFIX = 'phone pet-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'phone pet.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["phone pet.html","phone pet.js","phone pet.offline.html","phone pet.icon.png","phone pet.apple-touch-icon.png","phone pet.audio.worklet.js","phone pet.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["phone pet.wasm","phone pet.pck"];
